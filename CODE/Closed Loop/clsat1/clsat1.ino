...
double sensordistRead() {  
  ...
  relative_dist = sensor.getDistance();
  sum = sum + relative_dist;
  }
  final_relative_dist = ((sum/1000.00)+0.195005029)/7.0;
  return final_relative_dist;   
}
*/
/*===========================================================*/
...
/*===========================================================*/
/*
void velocity_func(nSat &sat_t) {
  sat_t.dist_hist[sat_t.i] = sensordistRead();
  if(sat_t.dist_hist[sat_t.i] > 0.60 | sat_t.dist_hist[sat_t.i] < 0.25 ) {
    sat_t.dist_hist[sat_t.i] = sat_t.dist_hist[sat_t.i-1];
  }
