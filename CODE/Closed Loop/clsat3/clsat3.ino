...
void setup() {
  ...
  sat.sat1.dist = sat.sat1.sensorDistRead(&S1);
  sat.sat1.dt = (double)millis()/1000.00;
  sat.sat1.dist_hist[1] = sat.sat1.dist;
  sat.sat1.dist_time[1] = sat.sat1.dt;

  // Initial Distance and timestamp
  sat.sat2.dist = sat.sat1.sensorDistRead(&S2);
  sat.sat2.dt = (double)millis()/1000.00;
  sat.sat2.dist_hist[1] = sat.sat2.dist;
  sat.sat2.dist_time[1] = sat.sat2.dt;
  delay(100);
